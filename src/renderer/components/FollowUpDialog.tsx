...
export default function FollowUpDialog(): JSX.Element | null {
  ...
  return (
    ...
    >
      <div className="w-[480px] max-w-full overflow-hidden rounded-lg border border-ink-700 bg-ink-900 shadow-float">
        ...
        <div className="px-5 py-4">
          <textarea
            ...
            className="w-full resize-y rounded-md border border-ink-700 bg-ink-950 px-2.5 py-1.5 font-mono text-[12px] leading-relaxed text-ink-100/90 outline-none transition-colors placeholder:text-ink-500 focus:border-accent focus:ring-2 focus:ring-accent-ring"
          />
